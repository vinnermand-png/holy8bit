...
export default function Header() {
  ...
  return <header className={`header${open ? " menu-open" : ""}`}>
    <div className="wrap header-inner">
      ...
      <nav className="nav" aria-label="Primary navigation"><a href="/scripture">Scripture</a><a href="/stories">Stories</a><a href="/gallery">Gallery</a><a href="/about">About</a></nav>
    ...
    <nav className="mobile-nav md:hidden" id="mobile-navigation" aria-label="Mobile navigation" aria-hidden={!open}>
      <a href="/scripture" onClick={close}>Scripture</a><a href="/stories" onClick={close}>Stories</a><a href="/gallery" onClick={close}>Gallery</a><a href="/about" onClick={close}>About</a>
    </nav>
  </header>;
}
